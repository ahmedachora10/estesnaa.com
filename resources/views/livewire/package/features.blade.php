<div>
    <div class="input-group mb-3" dir="ltr">
        ...
        <input type="text" class="form-control text-end" wire:model.defer="feature" placeholder="خاصية جديدة"
        ...
        @foreach ($features as $index => $item)
            <div class="col-md-4" dir="ltr">
                <div class="input-group mb-3">
                    <button class="btn btn-outline-secondary" wire:click="removeFeature({{ $index }})"
                        type="button" id="button-addon{{ $index }}">
                        <div class="bx bx-trash"></div>
                    </button>
                    <input type="text" value="{{ $item }}" name="features[]" class="form-control text-end"
